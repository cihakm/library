...
list($_b, $_g, $_l) = $template->initialize('3638197278', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbcedb685507_content')) { function _lbcedb685507_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _dataGrid
//
if (!function_exists($_b->blocks['_dataGrid'][] = '_lbf0565db654__dataGrid')) { function _lbf0565db654__dataGrid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('dataGrid', FALSE)
