...
list($_b, $_g, $_l) = $template->initialize('6064249577', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb5e200347a4_content')) { function _lb5e200347a4_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
