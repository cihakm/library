...
list($_b, $_g, $_l) = $template->initialize('4739081346', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb0a6ae72158_content')) { function _lb0a6ae72158_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
