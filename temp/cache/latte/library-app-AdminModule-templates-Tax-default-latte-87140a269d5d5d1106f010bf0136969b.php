...
list($_b, $_g, $_l) = $template->initialize('6984950894', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb046b7bbef8_content')) { function _lb046b7bbef8_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
