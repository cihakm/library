...
list($_b, $_g, $_l) = $template->initialize('5798095320', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbaf6088a1bf_content')) { function _lbaf6088a1bf_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
