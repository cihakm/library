...
list($_b, $_g, $_l) = $template->initialize('6610100500', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb51553e1610_content')) { function _lb51553e1610_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
