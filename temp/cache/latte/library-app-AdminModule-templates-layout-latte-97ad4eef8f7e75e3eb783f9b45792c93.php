...
">Ceník</a></li>
							...
							<li class="dropdown">
								<a href="#" data-toggle="dropdown"  class="dropdown-toggle">Katalog</a>
								<ul class="dropdown-menu">
									<li <?php try { $_presenter->link(":Admin:Catalog:books"); } catch (Nette\Application\UI\InvalidLinkException $e) {}; if ($_presenter->getLastCreatedRequestFlag("current")) { ?>
class="current"<?php } ?>><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Catalog:books"), ENT_COMPAT) ?>
">Knihy</a></li>
									<li <?php try { $_presenter->link(":Admin:Catalog:authors"); } catch (Nette\Application\UI\InvalidLinkException $e) {}; if ($_presenter->getLastCreatedRequestFlag("current")) { ?>
class="current"<?php } ?>><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Catalog:authors"), ENT_COMPAT) ?>
">Autoři</a></li>
									<li <?php try { $_presenter->link(":Admin:Catalog:categories"); } catch (Nette\Application\UI\InvalidLinkException $e) {}; if ($_presenter->getLastCreatedRequestFlag("current")) { ?>
class="current"<?php } ?>><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Catalog:categories"), ENT_COMPAT) ?>
">Kategorie</a></li>
									<li <?php try { $_presenter->link(":Admin:Catalog:publishers"); } catch (Nette\Application\UI\InvalidLinkException $e) {}; if ($_presenter->getLastCreatedRequestFlag("current")) { ?>
class="current"<?php } ?>><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Catalog:publishers"), ENT_COMPAT) ?>
">Vydavatelé</a></li>
								</ul>
							</li>
							<li class="dropdown">
...
class="current"<?php } ?>><a href="<?php echo Latte\Runtime\Filters::escapeHtml($_control->link(":Admin:Texts:"), ENT_COMPAT) ?>
">Texty</a></li>
								</ul>
							</li>
						</ul>
