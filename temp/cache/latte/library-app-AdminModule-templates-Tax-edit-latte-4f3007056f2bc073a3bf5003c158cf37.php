...
list($_b, $_g, $_l) = $template->initialize('9743021321', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb66fa2420b0_content')) { function _lb66fa2420b0_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
