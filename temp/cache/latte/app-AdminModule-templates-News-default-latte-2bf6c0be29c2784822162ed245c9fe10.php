...
list($_b, $_g, $_l) = $template->initialize('3385191996', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb444dc67001_content')) { function _lb444dc67001_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block _dataGrid
//
if (!function_exists($_b->blocks['_dataGrid'][] = '_lb57d29c960b__dataGrid')) { function _lb57d29c960b__dataGrid($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v; $_control->redrawControl('dataGrid', FALSE)
