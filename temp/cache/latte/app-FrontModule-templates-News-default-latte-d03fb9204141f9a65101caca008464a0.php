...
list($_b, $_g, $_l) = $template->initialize('6002434190', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbe1f264c748_content')) { function _lbe1f264c748_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div class="container">
