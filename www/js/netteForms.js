...
Nette.removeInitedForm = function(form) {

	$(form).off('submit.nette-form');

	$(form).off('click.nette-form');
...
Nette.initForm = function(form) {
	...
	$(form).on('submit.nette-form', function() {
	...
	$(form).on('click.nette-form', function(e) {
